...
```json
{
  "data": {
    "transactionInitialize": {
      ...
      "data": {
        "paymentIntent": {
          "client_secret": "PAYMENT_INTENT_CLIENT_SECRET_EXAMPLE"
        },
...
| `TEST_SALEOR_APP_TOKEN`            | _required_ | [AppToken](https://docs.saleor.io/docs/3.x/api-reference/apps/objects/app-token) | `SALEOR_APP_TOKEN_EXAMPLE`                                                                                                         |
...
| `TEST_PAYMENT_APP_SECRET_KEY`      | _required_ | Secret Key from Stripe                                                           | `STRIPE_SECRET_KEY_EXAMPLE`                                                                                                        |
| `TEST_PAYMENT_APP_PUBLISHABLE_KEY` | _required_ | Publishable Key from Stripe                                                      | `STRIPE_PUBLISHABLE_KEY_EXAMPLE`                                                                                                   |
| `TEST_PAYMENT_APP_WEBHOOK_ID`      | _required_ | ID of a webhook                                                                  | `we_1JaGFlH1Vac4G4dbZnQ8bviV`                                                                                                      |
| `TEST_PAYMENT_APP_WEBHOOK_SECRET`  | _required_ | Webhook Secret from Stripe                                                       | `STRIPE_WEBHOOK_SECRET_EXAMPLE`                                                                                                    |
